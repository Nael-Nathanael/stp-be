...
<?= $this->section("content"); ?>
    <form action="<?= route_to("object.articles.create", "PRESS-RELEASE") ?>" method="post" id="articleForm"
                ...
                <div class="d-flex justify-content-between align-items-end">
                    <div class="container-fluid">
                        <div class="small">
                            ...
                            /
                            <a class="text-light fw-lighter text-decoration-none" href="#">Add Press Release</a>
                        </div>
