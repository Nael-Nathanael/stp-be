                    ...
                    <div class="container-fluid">
                        <div class="small">
                            <a class="text-light fw-lighter text-decoration-none"
                               href="<?= route_to("dashboard.landing.ar") ?>">
                                Annual Reports
                            </a>
                            /
                            <a class="text-light fw-lighter text-decoration-none" href="#">Update Report</a>
                        </div>
                        ...
                        <div class="w-100">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="attachment">Update Attachment</label>
                                        <input type="file" name="attachment" id="attachment" class="form-control">
                                        <small>
                                            Prev: <a href="<?= $article->attachmentUrl ?>" target="_blank" rel="noreferrer" download>
