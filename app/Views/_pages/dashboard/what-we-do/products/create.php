...
<?= $this->section("content"); ?>
    <form action="<?= route_to("object.articles.create", "PRODUCTS") ?>" method="post" id="articleForm"
                    ...
                    <div class="container-fluid">
                        <div class="small">
                            <a class="text-light fw-lighter text-decoration-none"
                               href="<?= route_to("dashboard.what-we-do.products") ?>">
                                What We Do
                            </a>
                            /
                            ...
                            /
                            <a class="text-light fw-lighter text-decoration-none" href="#">Add Product</a>
                        </div>
                                ...
                                <div class="col-4">
                                    <div class="card card-body shadow">
                                        <div class="form-group mb-2">
                                            <label for="title_<?= $item ?>" class="small">Product Name [<?= $item ?>
                                                ]</label>
