        ...
        <div class="row align-items-center">
            <div class="col-6">
                ...
                <div class="h3 fw-semibold">
                    <?= summon_editable_ckeditor("Sustainability Header Title", "SUSTAINABILITY_HEADER_TITLE") ?>
                </div>

                <div class="fw-semibold">
                    <?= summon_editable_ckeditor("Sustainability Header Content", "SUSTAINABILITY_HEADER_CONTENT") ?>
                </div>
            </div>
        </div>
    </section>
